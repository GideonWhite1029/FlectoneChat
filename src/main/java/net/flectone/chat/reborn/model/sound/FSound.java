package net.flectone.chat.reborn.model.sound;
...
public class FSound {
    ...
    public FSound(@Nullable Player sender, @Nullable Player recipient, @NotNull String name) {
        ...
        sounds = FlectoneChatReborn.getPlugin().getFileManager().getSounds();
    }
    ...
    public void play() {
        ...
        try {
            ...
            FlectoneChatReborn.warning("Incorrect sound " + params[0] + " for " + name + ".sound.type");
            e.printStackTrace();
        }
