package net.flectone.chat.reborn.model.player;
...
public class FPlayer {
    ...
    public void setStreamPrefix() {
        if (!getPlayer().hasPermission("flectonechatreborn.commands.stream")) return;
    ...
    public boolean isHaveCooldown(@NotNull String action) {
        ...
        boolean isHaveCooldown = cooldownTime != null
                ...
                && !getPlayer().hasPermission("flectonechatreborn.cooldowns." + action + ".bypass");
