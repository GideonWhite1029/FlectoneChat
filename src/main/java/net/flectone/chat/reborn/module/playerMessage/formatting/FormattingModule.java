package net.flectone.chat.reborn.module.playerMessage.formatting;

import net.flectone.chat.reborn.FlectoneChatReborn;
import net.flectone.chat.reborn.component.FImageComponent;
import net.flectone.chat.reborn.model.message.TextParameters;
...
public class FormattingModule extends FModule {
    ...
    public boolean isUrlAllowed(@Nullable CommandSender player, @NotNull String urlString) {
        ...
        if (matcher.find()) {
            ...
            return FlectoneChatReborn.getPlugin().getFileManager()
                    .getConfig()
